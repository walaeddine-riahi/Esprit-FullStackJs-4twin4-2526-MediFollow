...
export default function CreateQuestionnaire({ onSuccess }: CreateQuestionnaireProps) {
  ...
  const [specialty, setSpecialty] = useState<MedicalSpecialty>("GENERAL_MEDICINE");
              ...
              <div className="flex gap-2 justify-end">
                {generatedQuestions.length > 0 ? (
                  <>
                    ...
                    <Button onClick={useGeneratedQuestions}>Use These Questions</Button>
                  </>
                ) : (
                  <>
                    <Button variant="outline" onClick={() => setOpen(false)}>
