...
export function AIReportDialog({ isOpen, onClose, report, title = "Rapport AI Médical" }: AIReportDialogProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Généré par IA • {new Date().toLocaleDateString('fr-FR')} à {new Date().toLocaleTimeString('fr-FR')}
              </p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {report.summary && (
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Résumé de l'Analyse</h3>
          ...
          {report.detailedReport && (
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Rapport Détaillé</h3>
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4">
