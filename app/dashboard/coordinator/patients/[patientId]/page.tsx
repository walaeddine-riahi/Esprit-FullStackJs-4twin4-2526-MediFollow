...
export default function CoordinatorPatientDetailPage() {
  ...
  async function handleFlag() {
    ...
    const res = await flagCoordinatorEntry(patientId, {
      ...
      flagType,
      note: flagNote.trim() || "Signalement interne — Suspicion d’anomalie ou incomplétude.",
    });
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-10 rounded-2xl border border-blue-200 dark:border-blue-900/40 bg-blue-50/50 dark:bg-blue-950/20 p-6">
          ...
          <div className="mt-4 flex gap-2">
            <button
              type="button"
              onClick={() => setReminderMsg("Bonjour, merci de compléter vos constantes vitales pour aujourd'hui dans MediFollow.")}
            ...
            <button
              type="button"
              onClick={() => setReminderMsg("Bonjour, n'oubliez pas de soumettre votre questionnaire de suivi avant la date limite. C'est important pour votre équipe médicale.")}
