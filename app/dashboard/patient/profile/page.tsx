  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black p-6">
      <div className="max-w-3xl mx-auto">
          ...
          {isEditingMedicalProfile ? (
            <div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:border-red-400 dark:focus:border-red-500 focus:outline-none transition-colors"
                    placeholder="Service spécifique"
                  />
                </div>
              </div>
              ...
              <div className="flex gap-2 mb-4">
                <button
                  onClick={() => setIsEditingMedicalProfile(false)}
                  className="px-4 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700 transition-colors text-sm font-semibold"
                >
                  Enregistrer
                </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {hospital && (
                <div className="flex items-start gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-800">
                  <Activity className="size-5 text-blue-500 dark:text-blue-400 flex-shrink-0 mt-1" />
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                      Hôpital / Clinique
                    </p>
              ...
              {specialty && (
                <div className="flex items-start gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-800">
                  <Stethoscope className="size-5 text-blue-500 dark:text-blue-400 flex-shrink-0 mt-1" />
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                      Spécialité
                    </p>
              ...
              {height && (
                <div className="flex items-start gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-800">
                  <Activity className="size-5 text-green-500 dark:text-green-400 flex-shrink-0 mt-1" />
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                      Taille
                    </p>
        ...
        {(medicalBackground.diabetes ||
          medicalBackground.hypertension ||
          medicalBackground.cardiacDisease ||
          medicalBackground.asthmaOuBpco ||
          medicalBackground.cancer ||
          medicalBackground.otherConditions) && (
          <div className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-gray-200 dark:border-gray-800 p-6 mb-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              <div className="size-10 rounded-xl bg-orange-50 dark:bg-orange-500/10 flex items-center justify-center">
                <AlertCircle className="size-5 text-orange-600 dark:text-orange-400" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {medicalBackground.diabetes && (
                <div className="flex items-center gap-2 p-3 rounded-lg bg-orange-50 dark:bg-orange-500/10 border border-orange-200 dark:border-orange-500/20">
                  <div className="size-2 rounded-full bg-orange-600 dark:bg-orange-400" />
              ...
              {medicalBackground.otherConditions && (
                <div className="flex items-center gap-2 p-3 rounded-lg bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600">
                  <div className="size-2 rounded-full bg-gray-600 dark:bg-gray-400" />
        ...
        {medications.length > 0 && (
          <div className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-gray-200 dark:border-gray-800 p-6 mb-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              <div className="size-10 rounded-xl bg-green-50 dark:bg-green-500/10 flex items-center justify-center">
                <Pill className="size-5 text-green-600 dark:text-green-400" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                Médicaments Actuels
              </h3>
            ...
            <div className="space-y-3">
              {medications.map((med: any) => (
                ...
                >
                  <Pill className="size-5 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5" />
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      ...
                      {med.reason && <p>Raison: {med.reason}</p>}
                    </div>
                  </div>
                </div>
              ))}
