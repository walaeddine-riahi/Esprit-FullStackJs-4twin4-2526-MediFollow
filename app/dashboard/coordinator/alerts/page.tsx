      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-8 rounded-2xl border border-blue-200 dark:border-blue-900/40 bg-blue-50/30 dark:bg-blue-950/20 p-5">
          ...
          <p className="mt-1 text-xs text-gray-600 dark:text-gray-400">
            Collez un résumé clinique ou des symptômes. Le serveur tente d’abord
            le modèle BiomedBERT si compatible ; sinon le triage est fait par
            Mistral 7B (JSON).
          </p>
          <textarea
            value={aiTriageText}
              ...
              >
                <div className="flex flex-col gap-2 sm:flex-row sm:justify-between sm:items-start">
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white">
                      {a.patient?.user?.firstName || "Patient inconnu"}{" "}
                ...
                <div className="mt-4 border-t border-blue-200/50 dark:border-blue-900/30 pt-4 flex justify-end">
                  <button
                    ...
                    className="rounded-xl bg-blue-600 px-6 py-2.5 text-sm font-bold text-white hover:bg-blue-700 hover:shadow-lg transition-all active:scale-95"
                  >
